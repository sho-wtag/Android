...
public class MainActivity extends AppCompatActivity {
    ...
    private void showOtherItems(){
        float statXWelcome = 0 - welcome.getWidth();
        float endXWelcome = welcome.getX();
        ObjectAnimator animWelcome = ObjectAnimator.ofFloat(welcome,View.X, statXWelcome, endXWelcome);
        ...
        ObjectAnimator animSignIn = (ObjectAnimator)AnimatorInflater.
                loadAnimator(this, R.animator.sign_in_animator);
